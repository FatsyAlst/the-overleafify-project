\chapter{Tipos de documentos e estruturas}\label{cap:1_typer_doc_struct}

\chapterquote{''O \LaTeX{} é a ferramenta perfeita para dar forma às suas ideias.''}{Leslie Lamport}

O LaTeX fornece diferentes classes de documentos, cada uma projetada para atender a necessidades específicas, como artigos científicos, monografias e livros. Escolher a classe correta é fundamental para garantir que o documento siga padrões adequados de formatação e estruturação. O sistema de classes foi definido inicialmente por Leslie Lamport em sua documentação oficial \cite{lamport1994latex}.

% --------

\section{Classes de documentos no \LaTeX{}}
\label{sec:cap1_classes_de_documentos_no_latex} % Referência cruzada para esta seção
