...
\label{cap:7_layout_profissional}

\chapterquote{``A simplicidade é o último grau de sofisticação.''}{Leonardo da Vinci}

Um layout bem estruturado melhora significativamente a legibilidade e a apresentação de documentos acadêmicos e técnicos. O \LaTeX{} oferece diversas ferramentas para personalizar margens, cabeçalhos, rodapés e espaçamento de texto. Este capítulo explora as principais configurações para criar documentos com um layout profissional e visualmente organizado.

% --------

\section{Controle de geometria da página}
\label{sec:cap7_controle_de_geometria_da_página} % Referência cruzada para esta seção
...
Esta é uma \textbf{tcolorbox}.
\end{tcolorbox}

\begin{tcolorbox}[tile,flip title={sharp corners},
title=Meu título,colback=red!10,
colbacktitle=red!75!black]
Esta é uma \textbf{tcolorbox}.
\end{tcolorbox}

\begin{tcolorbox}[enhanced,title=Meu título,
...
title={#1}}
\begin{mybox2}{Título curto}
Esta é uma \textbf{tcolorbox}.
\end{mybox2}\bigskip
\begin{mybox2}{Este não é um título tão curto}
Esta é uma \textbf{tcolorbox}.
\end{mybox2}
...
\begin{mybox3}[title=Uma caixa de múltiplas sombras]
Esta é uma \textbf{tcolorbox}.
\end{mybox3}
...
Agora que você aprendeu a criar layouts profissionais, aprimorando a apresentação e o design dos seus documentos, no Capítulo~\ref{cap:8_graf_diagra} vamos explorar a criação de gráficos e diagramas, ferramentas essenciais para a visualização e organização dos dados.